...
public class BigDataClusterEater5 {

	public static void main(String[] args) {
		String appName = "q2.BigDataClusterEater5";

		if (args.length != 6) {
			System.out.println("args: input file, use scaling, use pca, pcaK, random seed, vectorSize");
			exit(0);
		}

		System.out.println("InputFile: "+args[0]);
		System.out.println("Use Scaling: "+args[1]);
		System.out.println("Use PCA: "+args[2]);
		System.out.println("pcaK: "+args[3]);
		System.out.println("Random Seed: "+args[4]);
		System.out.println("VectorSize: "+args[5]);

		String inFile = args[0];
		int useScaling = Integer.parseInt(args[1]);
		int usePCA = Integer.parseInt(args[2]);
		int pcaK = Integer.parseInt(args[3]);
		...
		pipeFeature = new String("wordvec");
