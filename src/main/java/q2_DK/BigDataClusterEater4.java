...
public class BigDataClusterEater4 {

	public static void main(String[] args) {
		String appName = "q2.BigDataClusterEater4";

		if (args.length != 8) {
			System.out.println("args: input file, hashing features, use scaling, use pca, pcaK, random seed, alpha, lambda");
			exit(0);
		}
		...
		System.out.println("alpha: "+args[6]);
		System.out.println("lambda: "+args[7]);
		...
		LogisticRegression lr = new LogisticRegression()
				...
				.setRegParam(lambda) //Set Lambda
				.setElasticNetParam(alpha); //Set Alpha
		;
