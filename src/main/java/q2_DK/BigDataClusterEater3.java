...
public class BigDataClusterEater3 {

	public static void main(String[] args) {
		String appName = "q2.BigDataClusterEater3";

		if (args.length != 7) {
			System.out.println("args: input file, hashing features, use scaling, use pca, pcaK, dtMaxDepth, random seed");
			exit(0);
		}
		...
		System.out.println("dtMaxDepth: "+args[5]);
		System.out.println("Random Seed: "+args[6]);
		...
		int dtMaxDepth = Integer.parseInt(args[5]);
		long randomSeed = Long.parseLong(args[6]);
		...
		DecisionTreeClassifier lr = new DecisionTreeClassifier()
				.setFeaturesCol(pipeFeature)
				.setLabelCol("indexedSentiment")
				.setMaxDepth(dtMaxDepth)
		;
