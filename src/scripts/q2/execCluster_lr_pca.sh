...
do
  ...
  sleep 3
  spark-submit --class q2.SparkLoadLinearRegressionWithPCA --master yarn --deploy-mode cluster skdd_lr_pca.jar resources/kaggle-news-train.csv resources/kaggle-news-test.csv $randomSeed 8000
