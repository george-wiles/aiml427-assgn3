...
do
  ...
  sleep 3
  spark-submit --class q2.SparkLoadLinearRegression --master yarn --deploy-mode cluster skdd_lr.jar resources/kaggle-news-train.csv resources/kaggle-news-test.csv $randomSeed 800
